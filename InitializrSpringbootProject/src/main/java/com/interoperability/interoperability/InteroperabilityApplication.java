    ...
    public static void main(String[] args) throws Exception {
       SpringApplication.run(InteroperabilityApplication.class, args);
        try {
            ...
            /**HostelDTO r = new HostelDTO();
            r.setAddressHostel("8 rue de la joie");
            r.setCapacityHostel(25);
            ContactDTO c = new ContactDTO();
            c.setFirstnamePerson("serge");
            c.setNamePerson("delacompta");
            r.setContactHostel(c);
            r.setNameHostel("Hotelito");
            r.setOpeningPeriodHostel("Ouvert tout l'été");
            r.setTimetableOpenHostel("De 8h à 18h");
            r.setStarHostel(3);
